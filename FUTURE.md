...
* Expand **SIMD** operations to additional features for better performance.
    * **Centroid handling**
    * **Vector comparison**
...
Further minimize the vector search space by dividing the current smallest parts (**Shard**) into smaller **Bucket-objects**. Would further decrease overall search time, and would lessen search burden on Cache.
